...
| `Deque` / `ArrayDeque` | `new ArrayDeque<>()` | Estrutura que pode ser usada como fila (FIFO) ou pilha (LIFO) de modo eficiente, sem sincronização desnecessária | [009](009/README.md) | [FilaDeCarregamentoTest](../src/test/java/challenges/day009/FilaDeCarregamentoTest.java) |
| `offer()` / `poll()` | `fila.offer(x); fila.poll();` | Adicionar no final e remover do início — fila FIFO — em vez de LinkedList ou Stack | [009](009/README.md) | [FilaDeCarregamentoTest](../src/test/java/challenges/day009/FilaDeCarregamentoTest.java) |
| `push()` / `pop()` | `pilha.push(x); pilha.pop();` | Adicionar no topo e remover do topo — pilha LIFO — na mesma `Deque`, só muda o lado | [009](009/README.md) | [FilaDeCarregamentoTest](../src/test/java/challenges/day009/FilaDeCarregamentoTest.java) |
| Validar intervalo de parâmetro | `if (primeiros < 0 \|\| primeiros > pacotes.size())` | Rejeitar um `int` fora dos limites válidos de índice/contagem antes de usá-lo | [009](009/README.md) | [FilaDeCarregamentoTest](../src/test/java/challenges/day009/FilaDeCarregamentoTest.java) |
