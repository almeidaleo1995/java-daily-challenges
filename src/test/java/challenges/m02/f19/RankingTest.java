...
class RankingTest {
  ...
  void ordenaDoMaiorParaOMenor() {
    List<Jogador> jogadores =
        new ArrayList<>(
            List.of(new Jogador("Bia", 10), new Jogador("Duda", 30), new Jogador("Caio", 20)));

    Ranking.ordenarPorPontuacao(jogadores);

    assertEquals(
        List.of(new Jogador("Duda", 30), new Jogador("Caio", 20), new Jogador("Bia", 10)),
        jogadores);
  }
  ...
  void empateNaPontuacaoDesempataPeloNomeAlfabetico() {
    List<Jogador> jogadores =
        new ArrayList<>(
            List.of(new Jogador("Bia", 10), new Jogador("Ana", 20), new Jogador("Caio", 20)));

    Ranking.ordenarPorPontuacao(jogadores);

    assertEquals(
        List.of(new Jogador("Ana", 20), new Jogador("Caio", 20), new Jogador("Bia", 10)),
        jogadores);
  }
  ...
  void listaJaOrdenadaPermaneceIgual() {
    List<Jogador> jogadores =
        new ArrayList<>(List.of(new Jogador("Ana", 20), new Jogador("Bia", 10)));
